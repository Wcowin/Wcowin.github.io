...
<!-- Live Demo (同主页效果，独立 ID 防止冲突) -->
<div class="gh-heatmap-demo">
  <div class="github-heatmap-glass-container">
    <div class="github-heatmap-glass-card">
      <div class="github-heatmap-header">
        ...
        <span class="github-heatmap-stats">过去一年 <strong id="stats-count-demo">--</strong> 次贡献</span>
      </div>
      <div class="github-heatmap-content">
        <svg id="heatmapSvg-demo" class="github-heatmap-svg" preserveAspectRatio="xMidYMid meet"></svg>
      </div>
    ...
    <div id="heatmapTooltip-demo" class="github-heatmap-tooltip">
  ...
  <style>
    /* 仅给本教程页的 Demo 用，避免影响全站其它样式 */
    .gh-heatmap-demo .github-heatmap-glass-container {
      position: relative;
      margin: 12px 0 18px;
    }

    .gh-heatmap-demo .github-heatmap-glass-card {
    ...
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-glass-card {
      background: rgba(17, 24, 39, 0.96);
      border-color: rgba(148, 163, 184, 0.55);
      box-shadow: 0 10px 32px rgba(0, 0, 0, 0.65);
    }

    .gh-heatmap-demo .github-heatmap-header {
      display: flex;
    ...
    .gh-heatmap-demo .github-heatmap-title {
      font-size: 1.1rem;
      font-weight: 600;
      margin: 0;
    ...
    .gh-heatmap-demo .github-heatmap-stats {
      font-size: 0.8rem;
      color: var(--md-typeset-color);
      opacity: 0.6;
      white-space: nowrap;
    ...
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-title,
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-stats,
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-legend {
      color: #e5e7eb;
    }
    ...
    .gh-heatmap-demo .github-heatmap-stats strong {
      color: #239a3b;
      font-weight: 700;
      opacity: 1;
    }

    .gh-heatmap-demo .github-heatmap-content {
      position: relative;
      overflow-x: auto;
      overflow-y: hidden;
      margin: 0 -12px;
    ...
    .gh-heatmap-demo .github-heatmap-svg {
      width: 100%;
      height: auto;
      display: block;
      min-height: 110px;
    ...
    .gh-heatmap-demo .github-heatmap-footer {
      display: flex;
      justify-content: flex-end;
      margin-top: 10px;
    }

    .gh-heatmap-demo .github-heatmap-legend {
      display: flex;
      align-items: center;
      gap: 5px;
      font-size: 0.75rem;
    ...
    .gh-heatmap-demo .legend-label {
      font-weight: 500;
    }

    .gh-heatmap-demo .legend-cell {
      width: 11px;
      height: 11px;
      border-radius: 2px;
    ...
    .gh-heatmap-demo .github-heatmap-tooltip {
      position: fixed;
      pointer-events: none;
      z-index: 1000;
      display: none;
    ...
    .gh-heatmap-demo .github-heatmap-tooltip.visible {
      display: block;
      animation: tooltipFadeIn 150ms ease-out;
    }

    .gh-heatmap-demo .github-heatmap-tooltip__content {
    ...
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-tooltip__content {
      background: rgba(17, 24, 39, 0.95);
      border-color: rgba(148, 163, 184, 0.3);
    }

    .gh-heatmap-demo .github-heatmap-tooltip__arrow {
      position: absolute;
      width: 0;
      height: 0;
      border-style: solid;
    ...
    .gh-heatmap-demo .github-heatmap-tooltip.arrow-top .github-heatmap-tooltip__arrow {
      bottom: 100%;
      left: 50%;
    ...
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-tooltip.arrow-top .github-heatmap-tooltip__arrow {
      border-color: transparent transparent rgba(17, 24, 39, 0.95) transparent;
    }

    .gh-heatmap-demo .github-heatmap-tooltip.arrow-bottom .github-heatmap-tooltip__arrow {
      top: 100%;
      left: 50%;
      transform: translateX(-50%);
    ...
    [data-md-color-scheme="slate"] .gh-heatmap-demo .github-heatmap-tooltip.arrow-bottom .github-heatmap-tooltip__arrow {
  ...
  <script>
    (function () {
      ...
      const svg = document.getElementById("heatmapSvg-demo");
      const statsEl = document.getElementById("stats-count-demo");
      const tooltipEl = document.getElementById("heatmapTooltip-demo");
      ...
      function renderHeatmap(data) {
        ...
        data.contributions.forEach((day, idx) => {
          ...
          rect.addEventListener("mouseenter", (e) => tooltip(day.date, day.count, e));
          rect.addEventListener("mousemove", (e) => tooltip(day.date, day.count, e));
          rect.addEventListener("mouseleave", () => tooltipEl.classList.remove("visible"));
        ...
        if (!document.querySelector("style[data-heatmap-style-demo]")) {
          const style = document.createElement("style");
          style.setAttribute("data-heatmap-style-demo", "");
          style.textContent = `
            .gh-heatmap-demo .heatmap-label {
              fill: rgba(0, 0, 0, 0.4);
              font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', sans-serif;
              font-size: 10px;
            }
            [data-md-color-scheme="slate"] .gh-heatmap-demo .heatmap-label {
              fill: rgba(255, 255, 255, 0.7);
            }
            .gh-heatmap-demo .heatmap-cell {
              transition: opacity 150ms, filter 150ms;
              cursor: default;
              filter: drop-shadow(0 0 0 rgba(35, 154, 59, 0));
            }
            .gh-heatmap-demo .heatmap-cell:hover {
              opacity: 1 !important;
