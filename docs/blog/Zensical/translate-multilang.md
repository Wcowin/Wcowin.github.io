...
!!! tip "已废弃"
    由于微软翻译服务的性能速度和稳定性等等优点，目前本站已废弃**硅基流动 Qwen3-8B**翻译的客户端翻译方案，转而使用了**微软翻译服务**。可以阅读[微软翻译服务接入文档](./translate-microsoft.md)了解具体实现。
...
- **仓库地址**：[`Wcowin/WKwcowin.github.io`](https://github.com/Wcowin/WKwcowin.github.io)
- 与翻译相关的核心文件：
