...
苹果官方的开发者证书99美刀一年，独立开发者可能无力承担，本文介绍 [OneClip](https://github.com/One-Clip/OneClip) 如何通过**脚本自动化**实现个人证书对应用签名和应用分发，确保用户首次授权后，后续更新无需重新授权辅助功能。
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <item>
      ...
      <link>https://github.com/One-Clip/OneClip/releases</link>
      <description>OneClip $VERSION 更新</description>
      <pubDate>$(date -u +"%a, %d %b %Y %H:%M:%S +0000")</pubDate>
      <enclosure url="https://github.com/One-Clip/OneClip/releases/download/$VERSION/OneClip-$VERSION.dmg"
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <item>
      ...
      <enclosure url="https://github.com/One-Clip/OneClip/releases/download/v$VERSION/$APP_NAME-$VERSION.dmg"
                 sparkle:version="$VERSION"
                 sparkle:shortVersionString="$VERSION"
                 sparkle:edSignature="$SIGNATURE"
                 length="$FILE_SIZE"
