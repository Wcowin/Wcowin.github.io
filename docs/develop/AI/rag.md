...
微软于2024年开源的 GraphRAG，通过构建知识图谱来增强检索效果。2026 年，GraphRAG 已成为企业知识管理的重要技术方向。
...
**GraphRAG 适用场景**：
- 复杂关系查询（如"找出与某项目相关的所有人员和文档"）
- 多跳推理（需要跨越多个实体关系才能回答的问题）
- 企业知识图谱构建与问答
...
将 RAG 作为 Agent 的「工具」之一，按需检索、多步推理与规划，实现更复杂的问答与任务执行。2025-2026 年，RAG 是落地最成功的 AI 应用模式，被超过 60% 的企业 AI 应用采用。
...
### 7. GraphRAG 与知识图谱融合（2026 年新趋势）

- **知识图谱 + RAG**：GraphRAG 技术在企业知识管理场景快速落地
- **LongRAG**：支持更长上下文的检索增强方案
- **混合 RAG**：向量检索 + 图谱检索 + 关键词检索的多路召回
