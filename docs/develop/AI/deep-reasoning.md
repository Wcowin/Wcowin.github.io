...
Anthropic 在 2026 年发布 Claude 4 系列，进一步强化推理与编程能力：

| 模型 | 发布时间 | 核心特点 |
|------|----------|----------|
| **Claude Opus 4** | 2026年5月 | 旗舰级模型，重点强化编程能力、高级推理与 AI 代理任务 |
| **Claude Sonnet 4** | 2026年5月 | 性价比更高的中档模型，性能持平竞品但价格低 80% |
| **Claude Opus 4.7** | 2026年4月 | 在高级软件工程和复杂、长时间运行任务处理能力上显著提升 |
| **Claude Mythos** | 2026年4月 | 专注于漏洞识别和软件系统安全分析 |
