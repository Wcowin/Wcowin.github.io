...
| **Claude Mythos** | 2026年4月（Preview） | 定位在 Opus 之上、通用前沿模型，能力覆盖网络安全和生物/医疗等多个领域 |
...
- **1.6T 参数（MoE）**规模，性能跻身全球第一梯队
- **百万字（1M Token）超长上下文**支持
- **开源免费商用**，全量开源
- **国产算力全适配**

**DeepSeek-R2**（截至本文撰写尚未官宣）：
- 外界有"万亿级参数、支持多模态识图的下一代旗舰"的传闻，但 DeepSeek 官方尚未正式发布，本文不对其参数规模与能力下定论
