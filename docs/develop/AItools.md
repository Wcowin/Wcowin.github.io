...
- [DeepSeek](https://chat.deepseek.com/){target="_blank"} - 幻方量化推出的 AI 智能助手（V4 万亿参数、API 永久降价）
- [Kimi智能助手](https://kimi.moonshot.cn/){target="_blank"} - 月之暗面推出的 AI 智能助手（K2.6 完全开源，性能对标 GPT-5.4）
- [豆包](https://www.doubao.com/){target="_blank"} - 字节跳动推出的智能对话助手
- [通义千问](https://tongyi.aliyun.com/qianwen/){target="_blank"} - 阿里推出的自研大模型（Qwen3-Max-Thinking 等旗舰推理与 Agent）
- [文心一言](https://yiyan.baidu.com/){target="_blank"} - 百度推出的基于文心大模型的 AI 智能助手（文心 5.0 全模态）
- [讯飞星火](https://xinghuo.xfyun.cn/){target="_blank"} - 科大讯飞推出的 AI 智能助手
- [智谱清言](https://chatglm.cn/){target="_blank"} - 智谱推出的全能 AI 助手（GLM-5 等）
- [腾讯元宝](https://yuanbao.tencent.com/){target="_blank"} - 腾讯推出的免费 AI 智能助手
- [天工AI](https://www.tiangong.cn/){target="_blank"} - 昆仑万维推出的 AI 智能助手
- [MiniMax](https://www.minimaxi.com/){target="_blank"} - MiniMax 推出的 AI 智能问答助手（海螺视频 AI）
- [Poe](https://poe.com/){target="_blank"} - 问答社区 Quora 推出的多模型问答机器人
- [Copilot](https://copilot.microsoft.com/){target="_blank"} - 微软推出的网页版 Copilot 助手
- [Flowith](https://flowith.io/){target="_blank"} - 一站式使用 GPT、Claude、Gemini
- [Mistral](https://chat.mistral.ai/){target="_blank"} - Mistral AI 推出的对话助手
...
> 2026 年 AI 搜索标配多模态、引用透明与 Deep Research；Perplexity 仍为综合体验领先者，SearchGPT 已向全用户开放；GEO（生成式引擎优化）成为数字营销新方向。

- [秘塔AI搜索](https://metaso.cn/){target="_blank"} - 国内好用 AI 搜索，无广告、直达结果
- [Perplexity](https://www.perplexity.ai/){target="_blank"} - AI 搜索引擎与深度研究工具（引用透明、深度研究能力强）
- [SearchGPT](https://chatgpt.com/search){target="_blank"} - OpenAI 推出的 AI 搜索引擎（已全量开放，含购物与网络搜索）
- [夸克AI](https://quark.sm.cn/){target="_blank"} - 集 AI 搜索、网盘、文档、创作于一体
- [知乎直答](https://zhida.zhihu.com/){target="_blank"} - 知乎推出的 AI 搜索引擎
- [天工AI搜索](https://search.tiangong.cn/){target="_blank"} - 昆仑万维推出的 AI 搜索引擎
- [360AI搜索](https://so.360.com/){target="_blank"} - 360 推出的新一代 AI 搜索引擎
- [Devv](https://devv.ai/){target="_blank"} - 面向程序员的新一代 AI 搜索引擎
- [Phind](https://www.phind.com/){target="_blank"} - 专为开发者设计的 AI 搜索引擎
- [Perplexica](https://github.com/ItzHelix/Perplexica){target="_blank"} - Perplexity 开源替代品，支持本地部署
- [Exa](https://exa.ai/){target="_blank"} - AI 驱动的网络搜索，专为构建 AI 应用设计
...
- [代码小浣熊](https://raccoon.sensetime.com/){target="_blank"} - 商汤科技推出的免费 AI 编程助手
- [CodeBuddy](https://codebuddy.tencent.com/){target="_blank"} - 腾讯推出的 AI 编程助手
- [Bolt.new](https://bolt.new/){target="_blank"} - StackBlitz 推出的全栈 AI 代码工具
...
- [通义万相](https://wanxiang.aliyun.com/){target="_blank"} - 阿里推出的AI创意内容生成平台
- [可灵AI](https://klingai.kuaishou.com/){target="_blank"} - 快手推出的AI图像和视频创作平台
- [Civitai](https://civitai.com/){target="_blank"} - 免费的AI图像绘画作品和模型分享平台
- [remove.bg](https://www.remove.bg/){target="_blank"} - 强大的AI图片背景移除工具
- [标小智LOGO](https://www.logosc.cn/){target="_blank"} - AI Logo设计平台，一键生成企业Logo
- [ComfyUI](https://github.com/comfyanonymous/ComfyUI){target="_blank"} - 强大的 AI 图像生成工作流工具（开源）
- [Adobe Firefly](https://www.adobe.com/firefly.html){target="_blank"} - Adobe 推出的 AI 图像生成工具
...
- [PIKA](https://pika.art/){target="_blank"} - AI 视频生成工具
- [HeyGen](https://www.heygen.com/){target="_blank"} - 专业 AI 数字人视频创作平台
...
> 2026 年 AI PPT 工具大爆发：Gamma、讯飞智文、Kimi PPT、七牛 AI PPT 等持续迭代；豆包 PPT、ChatPPT 等新玩家加入。

- [Gamma](https://gamma.app/){target="_blank"} - AI幻灯片演示生成工具（国际主流）
- [百度文库AI助手](https://wenku.baidu.com/){target="_blank"} - 基于文心一言的一站式智能文档助手
- [Kimi PPT助手](https://kimi.moonshot.cn/){target="_blank"} - Kimi全新自研的PPT助手
- [讯飞智文](https://zhiwen.xfyun.cn/){target="_blank"} - 一键生成PPT和Word
- [AiPPT](https://www.aippt.cn/){target="_blank"} - AI快速生成高质量PPT
- [WPS AI](https://ai.wps.cn/){target="_blank"} - WPS 推出的 AI 办公助手
- [豆包PPT](https://www.doubao.com/){target="_blank"} - 字节跳动推出的 AI PPT 工具
- [ChatPPT](https://chatppt.yoo-ai.com/){target="_blank"} - AI 驱动的 PPT 生成工具
- [七牛AI PPT](https://www.7niu.com/){target="_blank"} - 国内 AI PPT 生成工具
- [Beautiful.ai](https://www.beautiful.ai/){target="_blank"} - 国际 AI PPT 工具（智能布局）
- [Tome](https://tome.app/){target="_blank"} - AI 驱动的演示文稿工具
- [美图AI PPT](https://www.meitu.com/){target="_blank"} - 美图秀秀推出的免费在线AI生成PPT设计工具
- [即触PPT](https://www.jichippt.com/){target="_blank"} - AI PPT 生成工具
- [办公小浣熊](https://raccoon.sensetime.com/){target="_blank"} - 最强AI数据分析助手

## AI 写作工具

- [笔灵AI写作](https://ibiling.cn/){target="_blank"} - 面向专业写作领域的AI写作工具
- [讯飞绘文](https://huiwen.xfyun.cn/){target="_blank"} - 免费AI写作工具，5分钟生成一篇原创稿
- [新华妙笔](https://miaobi.xinhuaskl.com/){target="_blank"} - 新华社推出的体制内办公学习平台
- [光速写作](https://guangsuxiezuo.com/){target="_blank"} - AI写作、PPT生成工具
- [橙篇](https://cp.baidu.com/){target="_blank"} - 百度推出的AI写作工具
- [Paperpal](https://www.editage.cn/paperpal){target="_blank"} - 英文论文写作助手
- [QuillBot](https://quillbot.com/){target="_blank"} - AI英/德语写作润色和改进工具
- [秘塔写作](https://metaso.cn/){target="_blank"} - AI 写作助手（与秘塔搜索联动）
- [Effidit](https://effidit.qq.com/){target="_blank"} - 腾讯 AI Lab 推出的智能写作助手
...
- [SkyLingo](https://skylingo.com/){target="_blank"} - AI 口语学习工具（2026年英语口语学习标杆产品）
- [移除人声](https://vocalremover.org/zh/){target="_blank"} - 移除人声并隔离
- [MusicLM](https://aitest.google.com/musiclm){target="_blank"} - Google 推出的 AI 音乐生成工具

## AI 设计工具

> 2026 年 AI 设计工具全面渗透：Figma AI、Adobe Firefly 持续迭代；UXbot、Framer 等 AI 原生工具崛起。

- [稿定AI](https://www.gaoding.com/){target="_blank"} - 一站式AI创作和设计平台
- [美图设计室](https://www.designkit.com/){target="_blank"} - AI图像创作和设计平台
- [Figma AI](https://www.figma.com/){target="_blank"} - Figma推出的原生AI设计工具
- [UXbot](https://uxbot.ai/){target="_blank"} - AI 原型生成和代码交付工具
- [创客贴AI](https://www.chuangkit.com/){target="_blank"} - AI辅助的智能在线设计工具
- [Canva](https://www.canva.com/){target="_blank"} - 在线设计工具Canva推出的AI设计工具
- [标小智LOGO](https://www.logosc.cn/){target="_blank"} - AI Logo设计平台，一键生成企业Logo
- [Framer](https://www.framer.com/){target="_blank"} - AI 交互原型与可发布产品
- [Adobe Firefly](https://www.adobe.com/firefly.html){target="_blank"} - Adobe 全家桶 AI 工具集成
- [Pixso](https://pixso.cn/){target="_blank"} - 国产 AI 一站式设计协作工具

## AI 翻译工具

- [SimplifyAI 文档翻译](https://translate.simplifyai.cn/){target="_blank"} - AI 文档翻译
- [书译](https://www.booktranslator.app/zh-CN/){target="_blank"} - 专业文档翻译
- [DeepL](https://www.deepl.com/zh/translator){target="_blank"} - 高质量 AI 翻译工具
- [沉浸式翻译](https://immersivetranslate.com/){target="_blank"} - 浏览器翻译插件，支持双语对照
- [网易有道翻译](https://fanyiguan.youdao.com/){target="_blank"} - 有道推出的 AI 翻译

## AI 内容检测

- [GPTzero](https://gptzero.me/){target="_blank"} - AI内容检测工具
- [AI成分鉴别器](https://app.illuminarty.ai/){target="_blank"} - 检测AI生成内容
- [Turnitin](https://www.turnitin.com/){target="_blank"} - 学术诚信检测工具（含 AI 检测）
- [Smodin](https://smodin.io/ai-content-detector){target="_blank"} - AI 内容检测器

## AI 学习资源

- [DeepLearning.AI](https://www.deeplearning.ai/){target="_blank"} - 吴恩达创办的AI学习平台
- [AI专栏](https://ai-bot.cn/ai-column/){target="_blank"} - AI工具集的AI教程专栏
- [AI百科](https://ai-bot.cn/ai-encyclopedia/){target="_blank"} - AI术语和概念百科
- [Coursera AI课程](https://www.coursera.org/browse/data-science/artificial-intelligence){target="_blank"} - AI 相关课程
- [Fast.ai](https://fast.ai/){target="_blank"} - 深度学习课程（免费）

## AI 导航合集

- [AI工具集](https://ai-bot.cn/){target="_blank"} - 国内外1000+ AI工具集合导航
- [Ai导航](https://www.ainavpro.com/){target="_blank"} - AI 工具导航
- [猫猫鱼AI工具窝](https://www.maomaoyu.coffee/zh){target="_blank"} - AI 工具导航
- [Toolify](https://toolify.ai/){target="_blank"} - 全球 AI 工具导航
- [There's An AI For That](https://theresanaiforthat.com/){target="_blank"} - AI 工具搜索
