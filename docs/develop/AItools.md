...
- [MiniMax](https://www.minimaxi.com/){target="_blank"} - MiniMax 推出的 AI 智能问答助手（M2.5 等）
...
> 2026 年 AI 搜索标配多模态、引用透明与 Deep Research；Perplexity 仍为综合体验领先者，SearchGPT 已向全用户开放。
...
> 2026 年图像生成向高质量与多模态演进：FLUX、GPT-image、Gemini 图像能力等；实时编辑与风格迁移成为新亮点。

- [即梦](https://jimeng.jianying.com/){target="_blank"} - 抖音旗下免费 AI 图片创作工具
- [Midjourney](https://www.midjourney.com/){target="_blank"} - AI 图像和插画生成工具
- [Stable Diffusion](https://stability.ai/){target="_blank"} - Stability AI 推出的文本到图像生成
- [堆友AI](https://d.design/){target="_blank"} - 阿里堆友推出的多风格AI绘画生成器
- [绘蛙](https://huiwa.cn/){target="_blank"} - AI电商营销工具，免费生成商品图
- [LiblibAI](https://www.liblib.art/){target="_blank"} - 国内领先的AI图像创作平台和模型分享社区
...
> 2026 年主流：Sora 2（电影级+原生音频）、Veo 3/3.1（4K、原生音频）、Runway Gen-4.5（画质基准高）；国内可灵 3.0 多模态与智能分镜、Kling 2.6 等持续迭代。

- [Sora](https://sora.com/){target="_blank"} - OpenAI 推出的 AI 视频生成（Sora 2：电影级画质、运动连贯、原生音频）
- [即梦AI](https://jimeng.jianying.com/){target="_blank"} - 一站式 AI 视频、图片、数字人创作工具
...
- [Gamma](https://gamma.app/){target="_blank"} - AI幻灯片演示生成工具
...
- [Suno](https://suno.com/){target="_blank"} - 高质量的AI音乐创作平台
- [海绵音乐](https://www.haimianyinyue.com/){target="_blank"} - 字节跳动推出的免费AI音乐创作平台
- [Udio](https://www.udio.com/){target="_blank"} - 免费的AI音乐创作工具
